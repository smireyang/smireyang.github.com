...
/* page2_bg */
    ...
    var bg_r = "off";
    var page = 0;
    var pageCount = $(".portfolio-page").length;

    // 처음에 2페이지 부터는 안보이게
    $(".portfolio-page").each(function(index){
        if(index>0){
    ...
    $(".logo_right").on("click",function(){
        ...
        $($(".portfolio-page").get(page)).fadeOut("fast",function (){
            // 마지막 페이지일경우 아이콘 변경
            ...
            $($(".portfolio-page").get(page)).fadeIn();
        });
        
        // $(".logo_right").find("i").attr("class","fas fa-chevron-circle-left");

        // alert($(".portfolio-page").length);
        // if(bg_r == "off"){
